                    ...
                    <table id="example3" class="display min-w850">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($blog->image)
                                    <img src="{{ asset($blog->image) }}" alt="Blog Image" class="img-thumbnail" width="100">
                                    @else
                                    No Image
                                    @endif
                                </td>
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('admin.blogs.edit', $blog->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
